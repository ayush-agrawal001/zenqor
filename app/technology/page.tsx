...
export default function About() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center top-[120px] sm:top-[180px] md:top-[256px] relative w-full h-full">
        ...
        <div className="mt-[60px] sm:mt-[80px] md:mt-[110px] w-full overflow-hidden">
        ...
        <div className="w-[90vw] sm:w-[85vw] md:w-[80vw] h-auto py-12 sm:h-[320px] bg-slate-800 mt-[80px] sm:mt-[120px] md:mt-[180px] relative flex justify-center items-center">
        ...
        <div className="dark relative w-full mt-[80px] sm:mt-[120px] md:mt-[160px] flex items-end justify-center">
          <Footer></Footer>
        </div>
      </div>
    </>
