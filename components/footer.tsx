...
const Footer = () => {
  return (
    <footer className="w-full px-4  sm:px-6 md:px-8 mx-auto max-w-[1200px]">
      <div className="flex flex-col sm:flex-row gap-8 ">
        ...
        <div className="flex flex-col space-y-4 w-full md:w-1/3">
          ...
          <p className="text-[16px] sm:text-base text-zinc-500 max-w-xs">
            Pioneering the future of AI <br/> & Quantum Computing.
          </p>
        </div>
        
        {/* Links section - stacks on mobile, side by side on larger screens */}
        <div className={`flex flex-col sm:flex-row justify-between sm:justify-around w-full sm:w-2/3 gap-8 sm:gap-0 ${inter.className}`}>
