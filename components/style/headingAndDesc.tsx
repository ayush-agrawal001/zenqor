  ...
  return (
    ...
    >
      <div className="">
        ...
        {subHeading && <div className="motion-scale-in-[0.60] motion-translate-x-in-[0%] motion-translate-y-in-[-220%] motion-opacity-in-[0%] motion-delay-[1ms] motion-delay-[0ms]/scale motion-delay-[0ms]/translate motion-duration-[1000ms]/opacity motion-delay-[0ms]/opacity">
          {subHeading}
        </div>}
